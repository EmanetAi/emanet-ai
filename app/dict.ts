...
export const dict: Record<Loc, LangPack> = {
  ...
  "ar": {
    "t": {
      ...
      "gate.hint": "اضغط على الختم لتترك أمانتك",
      ...
      "th.h": "<span class=\"ln\"><span class=\"w\">نحفظ</span></span><span class=\"ln\"><span class=\"w\">تقنيتك</span></span><span class=\"ln\"><span class=\"w\">كأمانة</span></span>",
      ...
      "wl.parallel": "نقسّم الهدف إلى مجموعة من وكلاء الذكاء الاصطناعي يعملون في الوقت نفسه، ثم نجمع نتائجهم في نتيجة واحدة.",
      "wl.relay": "استدعِ وكيل ذكاء اصطناعي كأنّه دالّة عادية — محفّز webhook مع مرحّل بريد، بلا أي اعتماديات.",
      ...
      "wl.classroom": "تطبيق Android أصلي: تسجيل حضور عبر QR، واختبارات مباشرة، وشروح بالذكاء الاصطناعي، وملاحظات تعليمية فورية.",
      "wl.iac": "تأمين وبنية تحتية مكتوبة ككود عبر GCP: Cloud Armor وKMS وVPC وGKE.",
