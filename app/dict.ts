...
export const dict: Record<Loc, LangPack> = {
  ...
  "ar": {
    "t": {
      ...
      "th.thesis": "<b>أوقِف إطلاق ميزات الذكاء الاصطناعي المعطوبة.</b> نبني وكلاء يُعتمَد عليهم وتكاملات سلسة يمكنك أن تثق بها فعلاً في بيئة الإنتاج.",
      "th.side": "<span class=\"arabic\" lang=\"ar\">أمانة</span>: وديعةٌ تُوضَع في رعايتك لتُرَدَّ كاملةً. هكذا نبني البرمجيات تمامًا — ما تُسلِّمه إلينا نرعاه ونُعيده سليمًا.",
      "th.cue": "اتبع الخيط",
      "pr.idx": "الممارسة",
